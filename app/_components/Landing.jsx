...
function Landing() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex">
    <div className="mx-auto max-w-xl text-center">
      ...
      <span className='text-main'>Upload, save</span> and easily <span className='text-main'>share</span> your files in one place
      </h1>

      <p className="mt-4 sm:text-xl/relaxed text-grey">
        {constants.desc}
      </p>
